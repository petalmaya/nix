...
(let* ((bg "#0f1417")
      ...
      (success "#c9c2ea")
      (on-success "#312c4c")
      (success-container "#474364")
      (on-success-container "#e5deff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#8ecff2")
      (primary-fixed-dim "#004d67")
      (secondary-fixed "#b5c9d7")
      (secondary-fixed-dim "#364954")
      (tertiary-fixed "#c9c2ea")
      (tertiary-fixed-dim "#474364")
      (on-primary-fixed "#003548")
      (on-primary-fixed-variant "#c1e8ff")
      (on-secondary-fixed "#1f333d")
      (on-secondary-fixed-variant "#d1e6f3")
      (on-tertiary-fixed "#312c4c")
      (on-tertiary-fixed-variant "#e5deff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#dfe3e7")
