...
(let* ((bg "#1a120d")
      ...
      (on-tertiary "#333209")
      (on-tertiary-container "#e8e5ac")
      (outline-color "#9f8d84")
      (outline-variant "#52443c")
      (primary "#ffb68a")
      (primary-container "#6f3811")
      (secondary "#e5bfa9")
      (secondary-container "#5c4131")
      (shadow "#000000")
      (surface "#1a120d")
      ...
      (tertiary "#cbc992")
      (tertiary-container "#49491e")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#cbc992")
      (on-success "#333209")
      (success-container "#49491e")
      (on-success-container "#e8e5ac")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffb68a")
      (primary-fixed-dim "#6f3811")
      (secondary-fixed "#e5bfa9")
      (secondary-fixed-dim "#5c4131")
      (tertiary-fixed "#cbc992")
      (tertiary-fixed-dim "#49491e")
      (on-primary-fixed "#522300")
      (on-primary-fixed-variant "#ffdbc8")
      (on-secondary-fixed "#432b1c")
      (on-secondary-fixed-variant "#ffdbc8")
      (on-tertiary-fixed "#333209")
      (on-tertiary-fixed-variant "#e8e5ac")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f0dfd7")
      (inverse-primary "#ffb68a")
      (inverse-surface "#1a120d")
