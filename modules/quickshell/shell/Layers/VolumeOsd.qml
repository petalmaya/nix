...
WlrLayershell {
  ...
  // Ignore the first Pipewire sink handoff on startup; only user-driven changes pop the OSD.
  ...
  Rectangle {
    ...
    // Lift clear of the launcher's bottom-center search field while it is open on this screen.
