...
# ~/.config/nixtop-shell/config.json; this script only reads it and applies.
#
# Usage:
...
CONFIG="${XDG_CONFIG_HOME:-$HOME/.config}/nixtop-shell/config.json"
CACHE="${XDG_CACHE_HOME:-$HOME/.cache}/nixtop-shell"
mkdir -p "$CACHE"
