...
(let* ((bg "#0e1416")
      ...
      (tertiary "#bdc5eb")
      (tertiary-container "#3d4565")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#bdc5eb")
      (on-success "#272f4d")
      (success-container "#3d4565")
      (on-success-container "#dce1ff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#83d2e5")
      (primary-fixed-dim "#004e5b")
      (secondary-fixed "#b2cbd2")
      (secondary-fixed-dim "#334a50")
      (tertiary-fixed "#bdc5eb")
      (tertiary-fixed-dim "#3d4565")
      (on-primary-fixed "#00363f")
      (on-primary-fixed-variant "#a6eeff")
      (on-secondary-fixed "#1c3439")
      (on-secondary-fixed-variant "#cde7ee")
      (on-tertiary-fixed "#272f4d")
      (on-tertiary-fixed-variant "#dce1ff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#dee3e5")
      (inverse-primary "#83d2e5")
      (inverse-surface "#0e1416")
