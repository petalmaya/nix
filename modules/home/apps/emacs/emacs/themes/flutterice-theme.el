...
(let* ((bg "#11131c")
      ...
      (on-secondary "#003545")
      (on-secondary-container "#bbe9ff")
      (on-surface "#e2e1ef")
      (on-surface-variant "#c2c5dd")
      (on-tertiary "#202c61")
      (on-tertiary-container "#dde1ff")
      (outline-color "#8c8fa6")
      (outline-variant "#424659")
      (primary "#60d4fe")
      ...
      (tertiary "#b8c4ff")
      (tertiary-container "#374379")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#b8c4ff")
      (on-success "#202c61")
      (success-container "#374379")
      (on-success-container "#dde1ff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#60d4fe")
      (primary-fixed-dim "#004d63")
      (secondary-fixed "#8ad0ee")
      (secondary-fixed-dim "#004d63")
      (tertiary-fixed "#b8c4ff")
      (tertiary-fixed-dim "#374379")
      (on-primary-fixed "#003545")
      (on-primary-fixed-variant "#bbe9ff")
      (on-secondary-fixed "#003545")
      (on-secondary-fixed-variant "#bbe9ff")
      (on-tertiary-fixed "#202c61")
      (on-tertiary-fixed-variant "#dde1ff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e2e1ef")
      (inverse-primary "#60d4fe")
      (inverse-surface "#11131c")
