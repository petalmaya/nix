...
(let* ((bg "#10131c")
      ...
      (on-secondary "#003543")
      (on-secondary-container "#b5ebff")
      (on-surface "#e1e1ef")
      (on-surface-variant "#c1c5dd")
      (on-tertiary "#1a2d60")
      (on-tertiary-container "#dbe1ff")
      (outline-color "#8b90a5")
      (outline-variant "#414659")
      (primary "#5bd5fa")
      (primary-container "#004e60")
      (secondary "#87d1eb")
      (secondary-container "#004e60")
      (shadow "#000000")
      (surface "#10131c")
      ...
      (surface-variant "#414659")
      (tertiary "#b4c5ff")
      (tertiary-container "#324478")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#b4c5ff")
      (on-success "#1a2d60")
      (success-container "#324478")
      (on-success-container "#dbe1ff")
      ;; Map fixed colors to regular colors
      (primary-fixed "#5bd5fa")
      (primary-fixed-dim "#004e60")
      (secondary-fixed "#87d1eb")
      (secondary-fixed-dim "#004e60")
      (tertiary-fixed "#b4c5ff")
      (tertiary-fixed-dim "#324478")
      (on-primary-fixed "#003543")
      (on-primary-fixed-variant "#b5ebff")
      (on-secondary-fixed "#003543")
      (on-secondary-fixed-variant "#b5ebff")
      (on-tertiary-fixed "#1a2d60")
      (on-tertiary-fixed-variant "#dbe1ff")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e1e1ef")
      (inverse-primary "#5bd5fa")
      (inverse-surface "#10131c")
