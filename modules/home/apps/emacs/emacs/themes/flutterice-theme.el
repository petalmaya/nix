...
(let* ((bg "#191114")
      ...
      (on-background "#eedfe2")
      (on-err "#690005")
      (on-err-container "#ffdad6")
      (on-primary "#531d38")
      (on-primary-container "#ffd8e6")
      (on-secondary "#412a33")
      (on-secondary-container "#fed9e6")
      (on-surface "#eedfe2")
      (on-surface-variant "#d4c2c7")
      (on-tertiary "#49280f")
      (on-tertiary-container "#ffdcc6")
      (outline-color "#9d8c92")
      (outline-variant "#504348")
      (primary "#ffb0d1")
      (primary-container "#6e334f")
      (secondary "#e1bdca")
      (secondary-container "#593f4a")
      (shadow "#000000")
      (surface "#191114")
      (surface-container "#251d20")
      (surface-container-high "#30282b")
      (surface-container-highest "#3b3235")
      (surface-container-low "#21191c")
      (surface-container-lowest "#130c0f")
      (surface-variant "#504348")
      (tertiary "#f1bb98")
      (tertiary-container "#633e23")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#f1bb98")
      (on-success "#49280f")
      (success-container "#633e23")
      (on-success-container "#ffdcc6")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffb0d1")
      (primary-fixed-dim "#6e334f")
      (secondary-fixed "#e1bdca")
      (secondary-fixed-dim "#593f4a")
      (tertiary-fixed "#f1bb98")
      (tertiary-fixed-dim "#633e23")
      (on-primary-fixed "#531d38")
      (on-primary-fixed-variant "#ffd8e6")
      (on-secondary-fixed "#412a33")
      (on-secondary-fixed-variant "#fed9e6")
      (on-tertiary-fixed "#49280f")
      (on-tertiary-fixed-variant "#ffdcc6")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#eedfe2")
      (inverse-primary "#ffb0d1")
      (inverse-surface "#191114")
