...
(let* ((bg "#1a110e")
      ...
      (outline-color "#a08d86")
      (outline-variant "#53433e")
      (primary "#ffb59a")
      (primary-container "#71361d")
      (secondary "#e7beaf")
      ...
      (success "#d5c78e")
      (on-success "#383005")
      (success-container "#50471a")
      (on-success-container "#f1e3a8")
      ;; Map fixed colors to regular colors
      (primary-fixed "#ffb59a")
      (primary-fixed-dim "#71361d")
      (secondary-fixed "#e7beaf")
      (secondary-fixed-dim "#5d4035")
      (tertiary-fixed "#d5c78e")
      (tertiary-fixed-dim "#50471a")
      (on-primary-fixed "#552009")
      (on-primary-fixed-variant "#ffdbce")
      (on-secondary-fixed "#442a20")
      (on-secondary-fixed-variant "#ffdbce")
      (on-tertiary-fixed "#383005")
      (on-tertiary-fixed-variant "#f1e3a8")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f1dfd9")
      (inverse-primary "#ffb59a")
      (inverse-surface "#1a110e")
