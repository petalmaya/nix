...
(let* ((bg "#141318")
      ...
      (primary "#cdbdff")
      (primary-container "#4b3e76")
      (secondary "#cbc3dc")
      (secondary-container "#494458")
      (shadow "#000000")
      (surface "#141318")
      ...
      (tertiary "#eeb8ca")
      (tertiary-container "#633b4a")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#eeb8ca")
      (on-success "#492533")
      (success-container "#633b4a")
      (on-success-container "#ffd9e4")
      ;; Map fixed colors to regular colors
      (primary-fixed "#cdbdff")
      (primary-fixed-dim "#4b3e76")
      (secondary-fixed "#cbc3dc")
      (secondary-fixed-dim "#494458")
      (tertiary-fixed "#eeb8ca")
      (tertiary-fixed-dim "#633b4a")
      (on-primary-fixed "#34275e")
      (on-primary-fixed-variant "#e8deff")
      (on-secondary-fixed "#322e41")
      (on-secondary-fixed-variant "#e7def8")
      (on-tertiary-fixed "#492533")
      (on-tertiary-fixed-variant "#ffd9e4")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e6e1e9")
