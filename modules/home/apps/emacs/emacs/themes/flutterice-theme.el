...
(let* ((bg "#1e100f")
      ...
      (on-background "#f8dcda")
      (on-err "#690005")
      (on-err-container "#ffdad6")
      (on-primary "#531357")
      (on-primary-container "#ffd6f9")
      (on-secondary "#4a204b")
      (on-secondary-container "#ffd6f9")
      (on-surface "#f8dcda")
      (on-surface-variant "#e7bdba")
      (on-tertiary "#571d1d")
      (on-tertiary-container "#ffdad7")
      (outline-color "#ad8885")
      (outline-variant "#5d3f3d")
      (primary "#fbacf7")
      (primary-container "#6d2d6f")
      (secondary "#eeb4e9")
      (secondary-container "#643663")
      (shadow "#000000")
      (surface "#1e100f")
      ...
      (surface-variant "#5d3f3d")
      (tertiary "#ffb3af")
      (tertiary-container "#733331")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#ffb3af")
      (on-success "#571d1d")
      (success-container "#733331")
      (on-success-container "#ffdad7")
      ;; Map fixed colors to regular colors
      (primary-fixed "#fbacf7")
      (primary-fixed-dim "#6d2d6f")
      (secondary-fixed "#eeb4e9")
      (secondary-fixed-dim "#643663")
      (tertiary-fixed "#ffb3af")
      (tertiary-fixed-dim "#733331")
      (on-primary-fixed "#531357")
      (on-primary-fixed-variant "#ffd6f9")
      (on-secondary-fixed "#4a204b")
      (on-secondary-fixed-variant "#ffd6f9")
      (on-tertiary-fixed "#571d1d")
      (on-tertiary-fixed-variant "#ffdad7")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f8dcda")
      (inverse-primary "#fbacf7")
      (inverse-surface "#1e100f")
