...
(let* ((bg "#1a1018")
      ...
      (outline-color "#a28a9c")
      (outline-variant "#544151")
      (primary "#c0c1ff")
      (primary-container "#3a3d8f")
      (secondary "#c0c1ff")
      (secondary-container "#3f4178")
      (shadow "#000000")
      (surface "#1a1018")
      (surface-container "#271c25")
      (surface-container-high "#32272f")
      (surface-container-highest "#3d313a")
      (surface-container-low "#221821")
      (surface-container-lowest "#140b13")
      (surface-variant "#544151")
      (tertiary "#f0b3e7")
      (tertiary-container "#653661")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#f0b3e7")
      (on-success "#4c1f49")
      (success-container "#653661")
      (on-success-container "#ffd7f6")
      ;; Map fixed colors to regular colors
      (primary-fixed "#c0c1ff")
      (primary-fixed-dim "#3a3d8f")
      (secondary-fixed "#c0c1ff")
      (secondary-fixed-dim "#3f4178")
      (tertiary-fixed "#f0b3e7")
      (tertiary-fixed-dim "#653661")
      (on-primary-fixed "#222578")
      (on-primary-fixed-variant "#e1e0ff")
      (on-secondary-fixed "#282a60")
      (on-secondary-fixed-variant "#e1e0ff")
      (on-tertiary-fixed "#4c1f49")
      (on-tertiary-fixed-variant "#ffd7f6")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f0dde9")
      (inverse-primary "#c0c1ff")
      (inverse-surface "#1a1018")
