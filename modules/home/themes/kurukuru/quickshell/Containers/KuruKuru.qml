...
Item {
  ...
  // plain bottom-rounded clip, not a real alpha-mask shape - was the
  // costliest of the mask-only MultiEffect spots since it's on the notch's
  // always-visible central widget rather than something conditional; see
  // handoff.md Session 18
  ClippingRectangle {
    anchors.bottom: parent.bottom
