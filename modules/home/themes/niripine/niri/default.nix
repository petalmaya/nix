  ...
  programs.niri = {
    ...
    settings = {
      ...
      layout = {
        ...
        # Border colours mirror rosepine-dark colours
        # love: #eb6f92, base: #191724, overlay: #26233a
        focus-ring = {
          enable = true;
          width = 3;
          active.color = "#eb6f92";   # rosepine love
          inactive.color = "#26233a"; # rosepine overlay
        };
        border.enable = false;
      };
