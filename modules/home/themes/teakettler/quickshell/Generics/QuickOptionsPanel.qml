...
// One-tap toggle grid for Layers/QuickOptions.qml; "Networks & devices" expands Generics/NetworkPanel.qml.
ColumnLayout {
  id: root
  ...
  RowLayout {
    ...
    // Debounce row; none of the three actions should fire twice.
    Timer {
      id: actionCooldown
