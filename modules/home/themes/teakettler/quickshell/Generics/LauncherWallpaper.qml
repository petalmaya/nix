...
Item {
      ...
      ListView {
        ...
        delegate: Item {
          ...
          Rectangle {
            ...
            // Overlay ring: a border on the parent gets painted over by the Image.
            Rectangle {
              id: selectionRing
    ...
    Rectangle {
      ...
      RowLayout {
        ...
        TextInput {
          ...
          // BeforeItem so Left/Right switch thumbnails instead of moving the cursor.
  ...
  // FolderListModel only globs, so wrap the query per extension. Skips gif/mp4.
