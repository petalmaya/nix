...
palette_file="${XDG_CACHE_HOME:-$HOME/.cache}/pinaceae/starship-palette.toml"
marker_begin="# >>> PINACEAE STARSHIP PALETTE >>>"
marker_end="# <<< PINACEAE STARSHIP PALETTE <<<"
...
discover_starship_config() {
    ...
    # Pinaceae applies templates from its daemon, which does not inherit shell-only
...
if [ ! -f "$config_file" ]; then
    ...
    # Strip the previous pinaceae palette block and any palette= line, keep the rest.
