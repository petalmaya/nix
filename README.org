...
i like niri and swayfx a lot, they look so pretty and smooth! :3

* Why?
wouldnt you like to know! but seriously, nix is just so comfy once you get the hang of it~
...
- =modules/= — my custom nixos and home manager modules
  ...
  - =home/= — home manager configuration (apps, services, terminal, wm, and themes!)
...
#+begin_src sh
  ...
  nixsw
#+end_src
(yes, i have a =nixsw= alias that does the hard rebuild work for me!)
...
* Who's Alice?
im alice, silly goose! just a girl who loves cute things, aesthetic desktops, and nix~ ♡
