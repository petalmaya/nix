...
(let* ((bg "{{colors.background.default.hex}}")
      ...
      (term0 "{{colors.surface_container_highest.default.hex}}")
      (term1 "{{colors.error.default.hex}}")
      (term2 "{{colors.primary.default.hex}}")
      (term3 "{{colors.tertiary.default.hex}}")
      (term4 "{{colors.secondary.default.hex}}")
      (term5 "{{colors.primary_container.default.hex}}")
      (term6 "{{colors.tertiary_container.default.hex}}")
      (term7 "{{colors.on_surface.default.hex}}")
      (term8 "{{colors.outline.default.hex}}")
      (term9 "{{colors.error_container.default.hex}}")
      (term10 "{{colors.primary_fixed.default.hex}}")
      (term11 "{{colors.tertiary_fixed.default.hex}}")
      (term12 "{{colors.secondary_container.default.hex}}")
      (term13 "{{colors.on_primary_container.default.hex}}")
      (term14 "{{colors.on_tertiary_container.default.hex}}")
      (term15 "{{colors.on_surface_variant.default.hex}}"))
